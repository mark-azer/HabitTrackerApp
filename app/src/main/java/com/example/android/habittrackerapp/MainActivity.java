...
public class MainActivity extends AppCompatActivity {
    ...
    private void displayDatabaseInfo() {
        ...
        try {
            ...
            int hoursColumnIndex = cursor.getColumnIndex(HabitContract.HabitEntry.COLUMN_HABIT_HOURS);
    ...
    private void insertHabit() {
        ...
        // and Video Games' habit attributes are the values.
        ContentValues values = new ContentValues();
        values.put(HabitContract.HabitEntry.COLUMN_HABIT_NAME, "Video Games");
        values.put(HabitContract.HabitEntry.COLUMN_HABIT_HOURS, 3);
        values.put(HabitContract.HabitEntry.COLUMN_HABIT_LOCATION, "Home");

        // Insert a new row for Video Games in the database, returning the ID of that new row.
        // The first argument for db.insert() is the habits table name.
        // The second argument provides the name of a column in which the framework
        // can insert NULL in the event that the ContentValues is empty (if
        // this is set to "null", then the framework will not insert a row when
        // there are no values).
        // The third argument is the ContentValues object containing the info for Video Games.
